...
set(TANG_BUILD_TIMEOUT_SEC "900" CACHE STRING "Timeout in seconds for full Tang board build target (0 disables timeout)")
find_program(TANG_TIMEOUT_EXE timeout)
set(TANG_TIMEOUT_CMD)
if(TANG_BUILD_TIMEOUT_SEC AND NOT TANG_BUILD_TIMEOUT_SEC STREQUAL "0")
    if(TANG_TIMEOUT_EXE)
        set(TANG_TIMEOUT_CMD ${TANG_TIMEOUT_EXE} --signal=TERM --kill-after=30 "${TANG_BUILD_TIMEOUT_SEC}")
    else()
        message(WARNING "timeout tool not found; Tang build step timeouts are disabled")
    endif()
endif()
