...
// FCSP RX FIFO wrapper (skeleton)
//
// AXIS-style single-packet stream wrapper with frame metadata sideband.
// This scaffold currently provides pass-through behavior while locking in the
// interface contract for later storage/backpressure implementation.
module fcsp_rx_fifo #(
    ...
    // Reference DEPTH so strict tools don't complain before true FIFO storage exists.
    logic _unused_depth;
    always_comb begin
